        ...
        <div className='geodezic'>
            <div className='header_header'>
                    ...
                    {activeHandler === 11 && (
                        <div className='header_menu_supply_activate'>
                            ...
                            <div className="scaled-iframe-container">
                                <iframe src="http://localhost/geodezic" frameBorder="0"></iframe>
                            </div>
                ...
                <div className='geodezic_1'>
                    ...
                    <img className='geodezic_1_img' src='/public/Group 113.png'/>
                    <img className='geodezic_fon_img' src='/public/gaz_fon.png' />
                </div>
              ...
              <div className='geodezic_2_block'>
                ...
                <p className='geodezic_2_block_img_6' />
                  ...
                  <div className='geodezic_2_block_3'>
                    <img className='geodezic_2_block_1_img_3' src='/public/proekt.png'/>
                  ...
                  <div className='geodezic_2_block_5'>
                    <img className='geodezic_2_block_1_img_5' src='/public/exper.png'/>
                  ...
                  <div className='geodezic_2_block_6'>
                    <img className='geodezic_2_block_1_img_6' src='/public/lupa.png'/>
                ...
                <div className='geodezic_pdf'>
                    ...
                    <div className='geodezic_pdf_box'>
                        <div className='geodezic_pdf_box_1'>
                            ...
                            <a className='geodezic_pdf_box_title_1' href="public/sto-gazprom-18000.3-006-2017.pdf" download="sto-gazprom-18000.3-006-2017.pdf">18000.3-006-2017 Газораспределительная система. Организация проведения контроля за соблюдением требований промышленной безопасности при эксплуатации, строительстве и реконструкции. Основные положения</a>
                            <a className='geodezic_pdf_box_title_2' href="public/sto-gazprom-18000.3-006-2017.pdf" download="sto-gazprom-18000.3-006-2017.pdf">18000.3-006-2017 Газораспределительная система. Организация проведения контроля за соблюдением требований промышленной безопасности при эксплуатации, строительстве и реконструкции. Основные положения</a>
                            <a className='geodezic_pdf_box_title_3' href="public/sto-gazprom-18000.3-006-2017.pdf" download="sto-gazprom-18000.3-006-2017.pdf">18000.3-006-2017 Газораспределительная система. Организация проведения контроля за соблюдением требований промышленной безопасности при эксплуатации, строительстве и реконструкции. Основные положения</a>
                            <a className='geodezic_pdf_box_title_4' href="public/sto-gazprom-18000.3-006-2017.pdf" download="sto-gazprom-18000.3-006-2017.pdf">18000.3-006-2017 Газораспределительная система. Организация проведения контроля за соблюдением требований промышленной безопасности при эксплуатации, строительстве и реконструкции. Основные положения</a>
                            <a className='geodezic_pdf_box_title_5' href="public/sto-gazprom-18000.3-006-2017.pdf" download="sto-gazprom-18000.3-006-2017.pdf">18000.3-006-2017 Газораспределительная система. Организация проведения контроля за соблюдением требований промышленной безопасности при эксплуатации, строительстве и реконструкции. Основные положения</a>
                            <a className='geodezic_pdf_box_title_6' href="public/sto-gazprom-18000.3-006-2017.pdf" download="sto-gazprom-18000.3-006-2017.pdf">18000.3-006-2017 Газораспределительная система. Организация проведения контроля за соблюдением требований промышленной безопасности при эксплуатации, строительстве и реконструкции. Основные положения</a>
                        </div>
            ...
            <div className='geodezic_faq'>
                ...
                <div className='geodezic_faq_block'>
                    <div className={`geodezic_faq_block_1 ${activeHandler === 1 ? 'faq_1' : ''}`} onClick={() => handleClick(1)}>
                    ...
                    <div className={`geodezic_faq_block_2 ${activeHandler === 2 ? 'faq_2' : ''} ${activeHandler === 1 ? 'faq_2_2' : ''}`} onClick={() => handleClick(2)}>
                    ...
                    <div className={`geodezic_faq_block_3 ${activeHandler === 3 ? 'faq_3' : ''} ${activeHandler === 2 ? 'faq_3_3' : ''}`} onClick={() => handleClick(3)}>
                    ...
                    <div className={`geodezic_faq_block_4 ${activeHandler === 4 ? 'faq_4' : ''} ${activeHandler === 3 ? 'faq_4_4' : ''}`} onClick={() => handleClick(4)}>
                    ...
                    <div className={`geodezic_faq_block_5 ${activeHandler === 5 ? 'faq_5' : ''} ${activeHandler === 4 ? 'faq_5_5' : ''}`} onClick={() => handleClick(5)}>
                    ...
                    <div className={`geodezic_faq_block_6 ${activeHandler === 6 ? 'faq_6' : ''} ${activeHandler === 5 ? 'faq_6_6' : ''}`} onClick={() => handleClick(6)}>
                    ...
                    <div className={`geodezic_faq_block_7 ${activeHandler === 7 ? 'faq_7' : ''} ${activeHandler === 6 ? 'faq_7_7' : ''}`} onClick={() => handleClick(7)}>
                    ...
                    <div className={`geodezic_faq_block_8 ${activeHandler === 8 ? 'faq_8' : ''} ${activeHandler === 7 ? 'faq_8_8' : ''}`} onClick={() => handleClick(8)}>
                   ...
                   <div className={`geodezic_faq_block_9 ${activeHandler === 9 ? 'faq_9' : ''} ${activeHandler === 8 ? 'faq_9_9' : ''}`} onClick={() => handleClick(9)}>
